...
export default function HeroSection() {
  return (
    <section className="min-h-screen  ">
      <div
        className="relative min-h-[calc(100vh-2rem)] md:min-h-[calc(100vh-3rem)] overflow-hidden  border-white/10"
        style={{
          background: `
      ...
      >
        ...
        {/* Content Container */}
        <div className="relative z-20 mx-auto flex min-h-[calc(100vh-2rem)] md:min-h-[calc(100vh-3rem)] max-w-5xl flex-col items-center justify-center px-6 pb-32 pt-36 text-center">
